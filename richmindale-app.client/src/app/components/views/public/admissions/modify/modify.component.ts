...
export class ModifyComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.common.getUSCountry().subscribe(res => { this.campusCountries = res; });
    ...
    this.common.getUsLearningMethod().subscribe(res => { this.methods = res; });
    ...
    this.common.getCountries().subscribe(res => { this.countries = res; });
    this.common.getPhoneCodes().subscribe(res => { this.phoneCodes = res; });
    this.common.getCommonDropdown('Admission Documents').subscribe(res => { this.docTypes = res; });
  ...
  CategoryChange():void {
    this.common.getProgramByCategoryId(this.adm.ProgramCategoryId).subscribe(res => { this.programs = res; });
  }
  ...
  CountriesChange(frm:any)
  {
    ...
    {
      case 'main':
        this.common.getCampusByCountry(this.adm.CountryId).subscribe(res => { this.campuses = res; });
        break;
      case 'student':
        this.common.getStatesByCountryId(this.adm.StudentCountry).subscribe(res => { this.sStates = res;});
        break;
      case 'dad':
        this.common.getStatesByCountryId(this.adm.FatherCountry).subscribe(res => { this.fStates = res;});
        break;
      case 'mom':
        this.common.getStatesByCountryId(this.adm.MotherCountry).subscribe(res => { this.mStates = res;});
        break;
      case 'guard':
        this.common.getStatesByCountryId(this.adm.GuardianCountry).subscribe(res => { this.gStates = res;});
        break;
    }
  }
  ...
  StatesChange(frm:any)
  {
    ...
    {
      case 'student':
        this.common.getCitiesByStateId(this.adm.StudentState).subscribe(res => { this.sCities = res;});
        break;
      case 'dad':
        this.common.getCitiesByStateId(this.adm.FatherState).subscribe(res => { this.fCities = res;});
        break;
      case 'mom':
        this.common.getCitiesByStateId(this.adm.MotherState).subscribe(res => { this.mCities = res;});
        break;
      case 'guard':
        this.common.getCitiesByStateId(this.adm.GuardianState).subscribe(res => { this.gCities = res;});
        break;
    }
  }
  ...
  UploadClick(): void  {
      ...
      this.upload.uploadAdmissionFiles(this.doc).subscribe(res => {
        if(res.status === 'success') {
            ...
            this.service.loadAdmissionDocs(this.adm.Id).subscribe(result => { this.docs = result.data; });
        } else {
